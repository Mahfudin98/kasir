                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $produk->nama_barang }}" name="nama_barang">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $produk->hargasatuan }}" name="hargasatuan">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
