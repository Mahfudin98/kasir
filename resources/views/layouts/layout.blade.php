...
@if (Route::has('login'))
    @auth
        ...
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="/home"><img class="main-logo" src="{{asset('assets/img/logo/logoo.png')}}" alt="" /></a>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                {{--  <li><a title="Buat Toko" href="index.html"><span class="mini-sub-pro">Buat Toko</span></a></li>  --}}
                                <li><a title="Daftar Toko" href="/toko"><span class="mini-sub-pro">Daftar Toko</span></a></li>                                
                                <li><a title="Daftar Kasir" href="index-1.html"><span class="mini-sub-pro">Daftar Kasir</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Kotak Pesan</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Pesan" href="mailbox.html"><span class="mini-sub-pro">Pesan</span></a></li>
                                <li><a title="Laporan Penjualan" href="mailbox.html"><span class="mini-sub-pro">Laporan Penjualan</span></a></li>
                                <li><a title="Pemberitahuan" href="mailbox-view.html"><span class="mini-sub-pro">Pemberitahuan</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-table icon-wrap"></i> <span class="mini-click-non">Input Data</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Tambah Kasir" href="static-table.html"><span class="mini-sub-pro">Tambah Kasir</span></a></li>
                                <li><a title="Tambah Barang" href="data-table.html"><span class="mini-sub-pro">Tambah Barang</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-forms icon-wrap"></i> <span class="mini-click-non">Tambah Pegawai</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Tambah Kasir" href="basic-form-element.html"><span class="mini-sub-pro">Tambah Kasir</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												...
												<p>Selamat bekerja kembali <span class="bread-ntd"> {{ Auth::User()->name }}</span></p>
											</div>
										</div>
                                    </div>
                                </div>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="/"><img class="main-logo" src="{{asset('assets/img/logo/logoo.png')}}" alt="" /></a>
                <strong><img src="{{asset('assets/img/logo/logosp.png')}}" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-social-dtl">
